...
public class DisableRemainderController implements Initializable {
    @FXML
    ...
    void setConfirm() throws SQLException {
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("UPDATE  exreciseremindermanagement.reminder SET Enable = 0 WHERE date1 = ? and subject1 =?;");
